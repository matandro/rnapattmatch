...
<head>
    ...
    <![endif]-->
    <title>RNA Pattern Matcher</title>
</head>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}" tabindex="-1">
                    <img src="${pageContext.request.contextPath}/img/BGU-logo.png" alt="bgu" id="logo"/>
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li
                            ...
                            class="active"
                            <%}%>><a href="${pageContext.request.contextPath}/index.jsp">Find Pattern</a></li>
                    ...
                    <li
                            ...
                            class="active"
                            <%}%>><a href="${pageContext.request.contextPath}/AdditionalInfo.jsp">Additional
                        information</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
